    ...
    <div className="mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card className="overflow-hidden bg-white">
          <div className="p-4 border-b border-gray-200">
            <h3 className="font-medium text-gray-800">Median Price Trend</h3>
          </div>
          <div className="p-4">
          ...
          <div className="p-4 bg-gray-50 border-t border-gray-200">
            <div className="flex justify-between">
              <div>
                <div className="text-sm text-gray-500">Current Median Price</div>
        ...
        <Card className="overflow-hidden bg-white">
          <div className="p-4 border-b border-gray-200">
            <h3 className="font-medium text-gray-800">Inventory & Days on Market</h3>
          </div>
          <div className="p-4">
        ...
        <Card className="overflow-hidden bg-white">
          <div className="p-4 border-b border-gray-200">
            <h3 className="font-medium text-gray-800">Market Health</h3>
          </div>
          <div className="p-4">
          ...
          <div className="p-4 bg-gray-50 border-t border-gray-200">
            <div className="flex justify-between">
              <div>
                <div className="text-sm text-gray-500">Sale-to-List Ratio</div>
                <div className="text-xl font-semibold text-gray-800">
                  {currentData.saleToListRatio}%
                </div>
              </div>
              <div className="text-right">
                <div className="text-sm text-gray-500">Price Reductions</div>
                <div className="text-amber-600 font-medium">
