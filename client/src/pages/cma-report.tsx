    ...
    <div className="container mx-auto py-6 px-4 max-w-6xl">
      <div className="mb-6">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>CMA Report Generator</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <header className="mb-8">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h1 className="text-3xl font-bold text-[#071224]">CMA Report Generator</h1>
        </div>
      ...
      <Card className="mt-8">
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            <div>
              <h3 className="text-sm font-medium mb-2">For Sellers</h3>
            ...
            <div>
              <h3 className="text-sm font-medium mb-2">For Buyers</h3>
              <ul className="text-xs text-muted-foreground space-y-1 list-disc pl-4">
